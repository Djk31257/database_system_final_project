    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="mealGridView" runat="server" AllowSorting="True" AutoGenerateColumns="False" AutoGenerateSelectButton="True" DataKeyNames="meal_id" DataSourceID="mealSqlDataSource" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="time" HeaderText="時間" SortExpression="date, time" />
                <asp:BoundField DataField="TC" HeaderText="總熱量" SortExpression="TC" ReadOnly="True" />
            </Columns>
        ...
        <asp:GridView ID="mealFoodGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="mealFood_id" DataSourceID="mealFoodSqlDataSource" ForeColor="#333333" GridLines="None" HorizontalAlign="Center">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
        ...
        <asp:DropDownList ID="typeDropDownList" runat="server" AutoPostBack="True" DataSourceID="typeSqlDataSource" DataTextField="type" DataValueField="type">
        </asp:DropDownList>
