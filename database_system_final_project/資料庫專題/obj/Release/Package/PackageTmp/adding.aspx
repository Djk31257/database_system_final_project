        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="titleLabel" runat="server" style="font-size: xx-large" Text="請依據用餐時間輸入" ForeColor="White"></asp:Label>
                    <br /><br />
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td class="auto-style6">
                        ...
                        時間<input id="timeInput" type="time" asp-for="eatingTime" name="timeInput" runat="server" /><asp:Button ID="insertButton" runat="server" OnClick="insertButton_Click" Text="按此新增一餐" />
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td class="auto-style6">
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="nutrientTableSqlDataSource" DataTextField="name" DataValueField="name" Visible="False">
            </asp:DropDownList>
            &nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
