...
<body style="background-image: url('sky.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-position: center center">
    <form id="form1" runat="server">
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style2" style="text-align: center">
                        ...
                        <asp:TextBox ID="newPasswordTextBox" runat="server" style="font-size: large"></asp:TextBox>
                    </td>
        ...
        <asp:SqlDataSource ID="userAccountSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT account, password FROM userAccountTable WHERE (account = @account) AND (password = @password)" UpdateCommand="UPDATE userAccountTable SET password = @password">
            <SelectParameters>
